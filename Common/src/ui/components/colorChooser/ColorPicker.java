...
public class ColorPicker extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		GraphicsUtility.ombrageHorizontal(g2,0,0, getWidth(), getHeight(), Color.DARK_GRAY, 4, false);
	 ...
	 */
	private BagedLayoutedComponent expertControls = new BagedLayoutedComponent();
	...
	public ColorPicker(boolean showExpertControls, boolean includeOpacity) {
		...
		BagedLayoutedComponent options = new BagedLayoutedComponent();
		c.gridx = 0;
		c.gridy = 0;
		c.weightx = 1;
		c.weighty = 1;
	 ...
	 */
	public BagedLayoutedComponent getExpertControls() {
